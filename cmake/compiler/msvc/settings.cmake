...
set(MSVC_EXPECTED_VERSION_STRING "MSVC 2019")

if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS MSVC_EXPECTED_VERSION)
  message(FATAL_ERROR "MSVC: KargatumConsole requires version ${MSVC_EXPECTED_VERSION} (${MSVC_EXPECTED_VERSION_STRING}) to build but found ${CMAKE_CXX_COMPILER_VERSION}")
endif()
...
target_compile_options(kargatum-warning-interface
  INTERFACE
    /W3)
...
if(PLATFORM EQUAL 64)
  ...
  target_compile_definitions(kargatum-compile-option-interface
    INTERFACE
      -D_WIN64)
  ...
  target_compile_options(kargatum-compile-option-interface
    INTERFACE
      /arch:SSE2)
