...
{
    using FieldRow = std::unordered_map<uint32/*index*/, std::unique_ptr<Field>>;
    ...
    struct Iterator
    {
        ...
        Iterator& operator++() { if (!_ptr->NextRow()) _ptr = nullptr; return *this; }
    ...
    public:
        ...
        [[nodiscard]] FieldRow const* Fetch() const { return &_currRow; }
        ...
        auto begin() { return Iterator<ResultSet>(this); }
        static auto end()   { return Iterator<ResultSet>(nullptr); }
    ...
    public:
        ...
        auto begin() { return Iterator<PreparedResultSet>(this); }
        static auto end()   { return Iterator<PreparedResultSet>(nullptr); }
